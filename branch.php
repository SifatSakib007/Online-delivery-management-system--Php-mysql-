    ...
    <div class="main_concent">
      ...
      <div class="stf">
        <div class="form-popup" id="myForm">
          <form class="form-container" action="branch_conn_page.php" method="post">
            <h1>Add Branch</h1>
            ...
            <input type="number" placeholder="Enter mobile number" name="number1" required>
            <input type="number" placeholder="Enter additional mobile number" name="number2" required>
            <!--<a href="staff.php"><button type="submit" class="btn">Add</button></a>-->
            <a href="branch.php"><input type="submit" name="submit" value="Add" class="btn"></a>
